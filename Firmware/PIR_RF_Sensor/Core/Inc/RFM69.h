...
//communication
#define RF_NODE_ID 2
#define RF_NETWORK_ID 1
#define RF_MASTER_ID 1
#define RF_NUM_OF_RETRIES 3
#define RF_TX_TIMEOUT 200
...
bool checkInterruptStatus();		// Function check interrupt status
void RFM69_SetCSPin(bool CS_State); // function to control the GPIO tied to RFM69 chip select (parameter HIGH or LOW)
